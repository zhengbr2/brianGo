...
func (*ArithRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_arith_b5f08a1419d8778e, []int{0}
}
...
func (dst *ArithRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ArithRequest.Merge(dst, src)
}
...
func (*ArithResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_arith_b5f08a1419d8778e, []int{1}
}
...
func (dst *ArithResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ArithResponse.Merge(dst, src)
}
...
func init() { proto.RegisterFile("arith.proto", fileDescriptor_arith_b5f08a1419d8778e) }

var fileDescriptor_arith_b5f08a1419d8778e = []byte{
